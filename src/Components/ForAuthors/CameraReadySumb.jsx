...
const CameraReadySumb = () => {
  ...
  <section className={`${styles2.instructionsContent} space-y-4 text-justify text-[16px] leading-relaxed`}>
    ...
    <p>The final manuscript must include the appropriate copyright clearance notice at the bottom of the first page. Please refer to the LaTeX/Word template available at <a className="text-blue-700 font-medium underline" target="_blank" rel="noreferrer" href="https://neiecce2025.org/CallForPapers">https://neiecce2025.org/CallForPapers</a> and replace the dummy code at the bottom of first page of the paper with the following code:</p>
