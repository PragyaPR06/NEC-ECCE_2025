            ...
            <div className={styles.aboutUs}>
                ...
                <div className={styles.aboutUsInfo}>
                    ...
                    <p className={styles.anekTamilAboutUsPara}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, dolores dolor illo sit ipsum saepe iusto? Tempore laboriosam in, ex aperiam exercitationem ullam ab doloremque deserunt officia, iure necessitatibus natus.
                    </p>
                    <br />
