  ...
  return (
    <div className="scrolling-container">
      <div className="scrolling-text">
       ...
       <div style={{padding: 0, fontSize: 20}}> <a style={{color: 'red'}} href="/CallForPapers">Early Bird Registration ends on 5th May 2025, Student Travel Award Application process ends on 5th May 2025 . </a>  <span>  <strong> All papers presented in NE-IECCE 2025 will go to IEEE Xplore and will be eligible for further review for publication in IAS Transactions and Magazine. </strong></span>
