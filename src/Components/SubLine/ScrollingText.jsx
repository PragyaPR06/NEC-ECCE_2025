  ...
  return (
    <div className="scrolling-container">
      <div className="scrolling-text">
       ...
       <div style={{padding: 0, fontSize: 20}}> <a style={{color: 'red'}} href="/CallForPapers">Registration process will start from <strong>April 21, 2025</strong> . </a>  <span>  <strong> All papers presented in NE-IECCE 2025 will go to IEEE Xplore and will be eligible for further review for publication in IAS Transactions and Magazine. </strong></span>
