...
const Registrations = () => {
  ...
  • Each registration is valid for submission of 6 pages only. An additional paper and over-length pages are subject to extra fees per page. <span className="text-red-600"> Maximum number of pages allowed is 8</span><br />
  •  <span className="text-md text-green-700 animate-blink">Author: Indian/Foreign (Student) registrations are not eligible for North-East India Travel Award.</span><br />
  • For North-East India Travel Award, authors must register under <span className="text-red-600">Author: Indian/Foreign (Academia/Industry)</span>. Details are available on <a href="https://ne-iecce2025.org/studentAwards" className="text-blue-600 underline">https://ne-iecce2025.org/studentAwards</a><br />
  ...
  • The authors can pay the conference registration fee through SBI Collect (Indian Author) / Swift Transfer (Foreign Author) to the below bank account.<br />
  ...
  • If the registration is made under the category <span className="text-red-600">Author: Indian or Foreign (Academia/Industry), any one of the authors/co-authors</span> can present the accepted paper.<br />
  •  <span className="text-red-600">For availing student registration, the presenter of the paper must be the same as the registrant (please upload Student ID Card as proof)</span>.<br />
...
<div className="bg-[#fafafa] text-black p-5 rounded-xl mt-8">
    ...
    <table className="table-auto w-full text-sm">
      <tbody>
        ...
        <tr>
          ...
          <td className="p-2 text-green-600">State Bank of India NIT SILCHAR, ASSAM, INDIA</td>
        </tr>
      </tbody>
    </table>
  </div>
 ...
 <div className="mt-6 text-sm leading-relaxed">
    <p className="text-BLACK font-semibold">Step 2</p>
    <p className="mt-1">
      Please save the payment receipt in <strong>PDF format after Payment of registration fee.</strong> <br />
      Name the PDF file according to the given format:<br />
