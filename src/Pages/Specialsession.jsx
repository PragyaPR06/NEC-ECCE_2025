    ...
    return (
        ...
        <section className={styles2.importantNotice}>
            ...
            <ol className={styles2.submissionGuidelinesText}>
                <li>
                Last date to submit proposal:  <strong><span className={styles2.textCut}>November 30, 2024  </span>   December 10, 2024</strong>  
                </li>
                <li>
                Notification of acceptance of Special Session: <strong> December 15, 2024</strong>  
                </li>
                <li>
                Last date to submit digest in Special Session: <strong> <span className={styles2.textCut}>February 15, 2024  </span>  February 28, 2024</strong>
                </li>
            </ol>
        ...
        <section className={styles2.importantNotice}>
            ...
            <ul className={styles2.submissionGuidelinesText}>
                ...
                <li>
                <strong>Complimentary Conference Registration:</strong> <span className={styles2.blink}>One Complimentary  [Author: Indian or Foreign (Academia/Industry)] Registration</span>  will be provided to successful Special Sessions with at least 6 papers. The successful SS organizers must register for and attend the conference, and chair the corresponding sessions.
                </li>
            </ul>
            <br></br>
